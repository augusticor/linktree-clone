...
export const linksInfo = [
  ...
  },
  {
    ...
    link: 'https://stackoverflow.com/users/8455517/augusticor?tab=profile',
    icon: `https://d1fdloi71mui9q.cloudfront.net/Nq0Z9DAbQOSVCFxGlaOY_apple-touch-icon%402.png`,
    label: 'Stack Overflow',
    extraImgStyles: { filter: 'none' },
  },
  {
    id: 'link-duolingo',
