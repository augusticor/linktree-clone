	...
	return (
		<footer className='footer'>
			<button className='btn-svg'>
				<svg className='linktree-svg' data-testid='BlackGreenLogo' viewBox='0 0 137 25' enableBackground='new 0 0 24 24'>
					<title data-testid='svgTitle' id='title_0.5203647889172123'>
						title
					</title>
					<desc data-testid='svgDescription' id='description_0.5203647889172123'>
						description
					</desc>
					<g>
						<path
